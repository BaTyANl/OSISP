...
char** getShortVariables(const char* fname) {                               //Получение набора переменных среды из файла.
    FILE *f = NULL;
...
int includeString(const char* str1, const char* str2) {                     //Проверка вхождения.
